      ...
      <Section className="!pt-0">
            ...
            },
	    {
            ...
            },
	     {
	      ...
	      summary: "Strategic Marketing Leader with 9+ years of experience in designing and executing results-oriented marketing strategies, with expertise in brand strategy, market positioning, and performance-driven campaigns. Adept at driving market expansion and strengthening brand equity through strong, long-term client relationships that have significantly contributed to client retention and tremendous organizational growth.",
            },
	    {
              name: "Mr. Shiva Aryal",
